...
public class SettingsManager : MonoBehaviour
{
    ...
    private static Dictionary<string, object> _defaultValues = new Dictionary<string, object>()
    {
        ...
        ["RPF Motor Threshold"] = 0, // RPF MT
        ["RDF Motor Threshold"] = 0, // RDF MT
        ["LPF Motor Threshold"] = 0, // LPF MT
        ["LDF Motor Threshold"] = 0, // LDF MT
    ...
    public static Dictionary<string, string> fieldNamesAndTypes = new Dictionary<string, string>() 
    {
        ...
        ["LPF Max"] = "int",
        ["LDF Max"] = "int",
        ["RPF Motor Threshold"] = "int",
        ["RDF Motor Threshold"] = "int",
        ["LPF Motor Threshold"] = "int",
        ["LDF Motor Threshold"] = "int",
